...
Route::get('/reports/tenant-statement/export', [ReportController::class, 'tenantStatementExport'])->name('reports.tenant-statement.export');
Route::get('/reports/bill-wise-statement',        [ReportController::class, 'billWiseStatement'])->name('reports.bill-wise-statement');
Route::get('/reports/bill-wise-statement/pdf',    [ReportController::class, 'billWiseStatementPdf'])->name('reports.bill-wise-statement.pdf');
Route::get('/reports/bill-wise-statement/export', [ReportController::class, 'billWiseStatementExport'])->name('reports.bill-wise-statement.export');
...
Route::get('/reports/tenant-ledger/export', [ReportController::class, 'tenantLedgerExport'])->name('reports.tenant-ledger.export');
...
Route::get('/reports/tenant-ageing/export', [ReportController::class, 'tenantAgeingExport'])->name('reports.tenant-ageing.export');
...
Route::get('/reports/group-ageing/export', [ReportController::class, 'groupAgeingExport'])->name('reports.group-ageing.export');
...
Route::get('/reports/financial-summary/export', [ReportController::class, 'financialSummaryExport'])->name('reports.financial-summary.export');
...
Route::get('/reports/rent-schedule/export', [ReportController::class, 'rentScheduleExport'])->name('reports.rent-schedule.export');
