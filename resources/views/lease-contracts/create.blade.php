            ...
            <div class="form-grid">
                ...
                <div class="form-group" id="tenant_name_group">
                    ...
                    <input type="text" name="tenant_name" id="tenant_name_input"
                        ...
                        placeholder="Free-text tenant name" maxlength="255">
...
@push('scripts')
<script>
// Auto-fill tenant_name from selected tenant
...
const tenantNameGroup = document.getElementById('tenant_name_group');

tenantSelect.addEventListener('change', function() {
    if (this.value) {
        const text = this.options[this.selectedIndex].text;
        tenantNameInput.value = text;
    }
});
