...
/**
 * One property's worth of VAT return rows — a single tab within the
 * multi-sheet VatReturnExport workbook.
 */
class VatReturnSheetExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithTitle
{
