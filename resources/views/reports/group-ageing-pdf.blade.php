...
<div class="report-title">GROUP OUTSTANDING &mdash; AGEING REPORT</div>
...
<table class="ledger">
    ...
    <tbody>
        ...
        @empty
        <tr><td colspan="6" style="text-align:center;padding:20px;color:#64748B">No outstanding balances in this date range.</td></tr>
        @endforelse
...
<div class="footer-note">This is a computer-generated report. "On Account" credits are not tracked yet, so that column is always blank.</div>
